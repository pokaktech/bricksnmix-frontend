...
class TodaysSpecialOffer extends StatelessWidget {
   TodaysSpecialOffer() ;
          ...
          Row(
            ...
            children: [
              ...
              Padding(padding: EdgeInsets.all(ResponsiveInfo.isMobile(context)?8:12),
                ...
                child:   Text("Today’s Special Offer",maxLines: 1,style: TextStyle(fontSize:ResponsiveInfo.isMobile(context)? 17:20,fontWeight: FontWeight.bold,color: Color(0xffB6545A)),
              ...
              Padding(padding: EdgeInsets.all(ResponsiveInfo.isMobile(context)?8:12),
                  ...
                  child: Image.asset('assets/homecategory/redarrow.png',width: 30,height: 30,fit: BoxFit.fill,)
              ),
