    ...
    child: BottomNavigationBar(
        ...
        items:  <BottomNavigationBarItem>[
          BottomNavigationBarItem(
            icon: ColorFiltered(
        colorFilter:
        ColorFilter.mode((_selectedIndex==0)?Color(0xffff6624): Colors.black26, BlendMode.srcIn),
            child:
          ...
          BottomNavigationBarItem(
            icon: ColorFiltered(
              colorFilter:
              ColorFilter.mode((_selectedIndex==1)?Color(0xffff6624): Colors.black26, BlendMode.srcIn),
              child:
          ...
          BottomNavigationBarItem(
            icon: ColorFiltered(
              colorFilter:
              ColorFilter.mode((_selectedIndex==2)?Color(0xffff6624): Colors.black26, BlendMode.srcIn),
              child:
          ...
          BottomNavigationBarItem(
            icon: ColorFiltered(
              colorFilter:
              ColorFilter.mode((_selectedIndex==3)?Color(0xffff6624): Colors.black26, BlendMode.srcIn),
              child:
        ...
        selectedItemColor: Color(0xffff6624),
